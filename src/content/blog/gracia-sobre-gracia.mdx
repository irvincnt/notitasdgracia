export const metadata = {
  ...
  description:
    “Gracia sobre gracia” es más que una frase, es la realidad de una vida sostenida por Su amor, donde siempre hay suficiente, incluso en nuestros días más difíciles.,
  date: "2026-03-23",
